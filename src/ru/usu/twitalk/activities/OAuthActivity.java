...
public class OAuthActivity extends Activity {
	...
	private class RetrieveRequestTokenTask extends
		...
		protected void onPostExecute(String url) {
			...
			if (url != null) {
				App.saveRequestInformation(mSettings, mConsumer.getToken(),
						mConsumer.getTokenSecret());
				OAuthActivity.this.startActivity(new Intent(Intent.ACTION_VIEW,
						Uri.parse(url)));
			}
		}
	}
	...
	private class RetrieveAccessTokenTask extends
		...
		protected void onPostExecute(Boolean success) {
			...
			if (success) {
				...
				// These are the users token and secret for your app - protect
				// them
